...
It's a copy of https://github.com/NipunaMarcus/web-editor/tree/websocket-ls with some modifications in HelloTextDocumentService.java to read the flux commands from metafacture-core.
